...
object Dependencies {
  ...
  private[this] val protoSchemasLib =
    "com.wavesplatform" % "protobuf-schemas" % "1.3.2-50-SNAPSHOT" classifier "protobuf-src" intransitive ()
  ...
  private def nettyModule(module: String)                  = "io.netty"                      % s"netty-$module"   % "4.1.65.Final"
