...
//         |)""".stripMargin)
    ...
    val blockchain: Blockchain = new Blockchain {
      private val chainId: Byte = globalSettings.blockchain.addressSchemeCharacter.toByte
      ...
      override def settings: BlockchainSettings = globalSettings.blockchain

      // Ride: wavesBalance, height, lastBlock
      override def height: Int = input.height

      override val activatedFeatures: Map[Short, Int] = globalSettings.blockchain.functionalitySettings.preActivatedFeatures
