...
class UtxPoolImpl(
  ...
  private[this] val pessimisticPortfolios = new PessimisticPortfolios(spendableBalanceChanged, blockchain.transactionHeightAndStatus(_).isDefined) // TODO delete in the future
