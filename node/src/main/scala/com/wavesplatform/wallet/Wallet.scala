...
object Wallet extends ScorexLogging {
  ...
  private[this] final class WalletImpl(maybeFile: Option[File], passwordOpt: Option[String], maybeSeedFromConfig: Option[ByteStr])
    ...
    override def generateNewAccount(nonce: Int): Option[PrivateKeyAccount] = WalletLock.write {
    ...
    private[this] def generateNewAccountWithoutSave(nonce: Int): Option[PrivateKeyAccount] = WalletLock.write {
