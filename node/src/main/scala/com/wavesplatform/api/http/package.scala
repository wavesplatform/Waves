            ...
            TransactionParsers.by(typeId, version) match {
              ...
              case Some(x) =>
                x match {
                  ...
                  case ReissueTransaction      => TransactionFactory.reissueAssetV1(txJson.as[ReissueV1Request], senderPk)
                  case ReissueTransaction      => TransactionFactory.reissueAssetV2(txJson.as[ReissueV2Request], senderPk)
