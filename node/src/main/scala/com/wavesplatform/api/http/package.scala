            ...
            TransactionParsers.by(typeId, version) match {
              ...
              case Some(x) =>
                x match {
                  ...
                  case LeaseCancelTransaction  => TransactionFactory.leaseCancelV1(txJson.as[LeaseCancelV1Request], senderPk)
                  case LeaseCancelTransaction  => TransactionFactory.leaseCancelV2(txJson.as[LeaseCancelV2Request], senderPk)
