            ...
            TransactionParsers.by(typeId, version) match {
              ...
              case Some(x) =>
                x match {
                  ...
                  case IssueTransaction        => TransactionFactory.issueAssetV1(txJson.as[IssueV1Request], senderPk)
                  case IssueTransaction        => TransactionFactory.issueAssetV2(txJson.as[IssueV2Request], senderPk)
