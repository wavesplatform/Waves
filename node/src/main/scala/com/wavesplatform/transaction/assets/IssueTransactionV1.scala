...
object IssueTransactionV1 extends TransactionParserFor[IssueTransactionV1] with TransactionParser.HardcodedVersion1 {
  ...
  val byteTailDescription: ByteEntity[IssueTransactionV1] = {
    (
      ...
      BytesArrayUndefinedLength(tailIndex(4), "Asset name", TxConstraints.MaxAssetNameLength, TxConstraints.MinAssetNameLength),
      BytesArrayUndefinedLength(tailIndex(5), "Description", TxConstraints.MaxAssetDescriptionLength),
