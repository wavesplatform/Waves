...
object BlockchainFeatures {
  ...
  val BlockV5                         = BlockchainFeature(15, "VRF, Protobuf, Accept transactions with failed script result, Ride V4 and multiple attached payments for Invoke Script Transaction")
