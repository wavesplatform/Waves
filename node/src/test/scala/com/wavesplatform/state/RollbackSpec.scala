      ...
      case (sender, initialBalance, name, description) =>
        withDomain() { d =>
          ...
          d.blockchainUpdater.assetDescription(IssuedAsset(issueTransaction.id())) should contain(
            AssetDescription(issueTransaction.id(), sender, name, description, 8, true, BigInt(2000), Height @@ 0, None, 0)
          )
          ...
          d.blockchainUpdater.assetDescription(IssuedAsset(issueTransaction.id())) should contain(
            AssetDescription(issueTransaction.id(), sender, name, description, 8, false, BigInt(4000), Height @@ 0, None, 0)
          )
