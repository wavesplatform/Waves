  ...
  private def paymentPreconditions(
    ...
    for {
      ...
      for {
        ...
        ci <- InvokeScriptTransaction.selfSigned(1.toByte, invoker, master.toAddress, None, payments, fee, Waves, extraFeePerStep = InvokeScriptTransaction.DefaultExtraFeePerStep, ts + 3)
