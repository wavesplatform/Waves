...
class LevelDBWriterSpec extends FreeSpec with Matchers with TransactionGen with WithDB with WithDBSettings with RequestGen with ScalaCheckDrivenPropertyChecks {
  "Slice" - {
    "drops tail" in {
