...
bashScriptExtraDefines += s"""addJava "-Dwaves.defaults.directory=/var/lib/${(Universal / normalizedName).value}""""
bashScriptExtraDefines += s"""addJava "-Dwaves.defaults.config.directory=/etc/${(Universal / normalizedName).value}""""
