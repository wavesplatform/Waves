 ...
 *
 * A block has:
 * - transactions data: a sequence of transactions, where a transaction is an atomic state update, maybe
 * along with some metadata(transactions Merkle tree root, state Merkle tree root etc)
 *
