...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.wavesplatform" % "scorex-basics_2.11" % "1.4.8",
  "com.wavesplatform" % "scorex-consensus_2.11" % "1.4.8",
  "com.wavesplatform" % "scorex-transaction_2.11" % "1.4.8",
...
// LIBRARY_DEPENDENCIES_HASH d8cde063890db1ce7aa59c2a0fd0b8f75022968a
