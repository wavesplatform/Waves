...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.wavesplatform" % "scorex-basics_2.11" % "1.3.7",
  "com.wavesplatform" % "scorex-consensus_2.11" % "1.3.7",
  "com.wavesplatform" % "scorex-transaction_2.11" % "1.3.7",
...
// LIBRARY_DEPENDENCIES_HASH b709769d99583afddf64c7d3db363a9f1e5fa445
