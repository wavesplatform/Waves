...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.wavesplatform" % "scorex-basics_2.11" % "1.3.7-SNAPSHOT",
  "com.wavesplatform" % "scorex-consensus_2.11" % "1.3.7-SNAPSHOT",
  "com.wavesplatform" % "scorex-transaction_2.11" % "1.3.7-SNAPSHOT",
...
// LIBRARY_DEPENDENCIES_HASH 5a79cba0c9845902a86a7769c628fae936a9dbd3
