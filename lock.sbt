...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.github.dnvriend" % "akka-persistence-inmemory_2.11" % "1.3.15",
  ...
  "com.typesafe.akka" % "akka-persistence-query-experimental_2.11" % "2.4.13",
  ...
  "com.typesafe.akka" % "akka-stream-testkit_2.11" % "2.4.13",
  "com.typesafe.akka" % "akka-stream_2.11" % "2.4.13",
...
// LIBRARY_DEPENDENCIES_HASH 9628f25d8d66c6fa7cbf4a9d0b484f333837b78d
