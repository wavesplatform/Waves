...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.wavesplatform" % "scorex-basics_2.11" % "1.3.6",
  "com.wavesplatform" % "scorex-consensus_2.11" % "1.3.6",
  "com.wavesplatform" % "scorex-transaction_2.11" % "1.3.6",
...
// LIBRARY_DEPENDENCIES_HASH e54842d68f2909dcca8cca46a861bcfc4b677c1e
