...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.wavesplatform" % "scorex-basics_2.11" % "1.6.0-SNAPSHOT",
  "com.wavesplatform" % "scorex-consensus_2.11" % "1.6.0-SNAPSHOT",
  "com.wavesplatform" % "scorex-transaction_2.11" % "1.6.0-SNAPSHOT",
...
// LIBRARY_DEPENDENCIES_HASH 8cc0144ccc0d0508149e41dc99bfe13a533fa06f
