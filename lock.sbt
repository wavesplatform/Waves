...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.wavesplatform" % "scorex-basics_2.11" % "1.4.5",
  "com.wavesplatform" % "scorex-consensus_2.11" % "1.4.5",
  "com.wavesplatform" % "scorex-transaction_2.11" % "1.4.5",
...
// LIBRARY_DEPENDENCIES_HASH 1239b0ee9e86668610ccd477668df8032baaa6a5
