...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.typesafe.akka" % "akka-parsing_2.11" % "2.4.5",
  "com.typesafe.akka" % "akka-stream_2.11" % "2.4.5",
  "com.typesafe.akka" % "akka-testkit_2.11" % "2.4.5",
  ...
  "org.consensusresearch" % "scorex-basics_2.11" % "1.3.0-M1",
  "org.consensusresearch" % "scorex-consensus_2.11" % "1.3.0-M1",
  "org.consensusresearch" % "scorex-transaction_2.11" % "1.3.0-M1",
...
// LIBRARY_DEPENDENCIES_HASH 55d332081e59ace36e570a9f9ccdad510704971a
