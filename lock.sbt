...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.wavesplatform" % "scorex-basics_2.11" % "1.3.6-SNAPSHOT",
  "com.wavesplatform" % "scorex-consensus_2.11" % "1.3.6-SNAPSHOT",
  "com.wavesplatform" % "scorex-transaction_2.11" % "1.3.6-SNAPSHOT",
...
// LIBRARY_DEPENDENCIES_HASH 9416f988783051c81e199a43583e09028556428b
