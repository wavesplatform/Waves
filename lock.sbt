...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.github.dnvriend" % "akka-persistence-inmemory_2.12" % "2.4.17.3",
  ...
  "com.typesafe.akka" % "akka-persistence-query-experimental_2.12" % "2.4.17",
  "com.typesafe.akka" % "akka-persistence_2.12" % "2.4.17",
  "com.typesafe.akka" % "akka-protobuf_2.12" % "2.4.17",
