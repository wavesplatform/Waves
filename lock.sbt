...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.wavesplatform" % "scorex-basics_2.11" % "1.4.7-SNAPSHOT",
  "com.wavesplatform" % "scorex-consensus_2.11" % "1.4.7-SNAPSHOT",
  "com.wavesplatform" % "scorex-transaction_2.11" % "1.4.7-SNAPSHOT",
...
// LIBRARY_DEPENDENCIES_HASH 87ed315a5a1495b0a886992a6531e9a3c2ba9c4c
