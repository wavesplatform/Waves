...
import com.wavesplatform.state.{Diff, Portfolio, StateSnapshot}
...
object RollbackBenchmark extends ScorexLogging {
  def main(args: Array[String]): Unit = {
    ...
    rocksDBWriter.append(
      StateSnapshot.fromDiff(Diff(portfolios = portfolios.toMap), rocksDBWriter),
      0,
      0,
      None,
    ...
    val nextSnapshot = StateSnapshot.fromDiff(nextDiff, rocksDBWriter)
