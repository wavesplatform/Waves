...
object DataTestData {
  implicit val dt                       = Discriminated[DataType, Int](uint8)
  implicit val dtCodec: Codec[DataType] = mappedEnum(uint8, DataType.Boolean -> 0, DataType.ByteArray -> 1, DataType.Long -> 2)
