...
class EvaluatorV2Test extends PropSpec with Inside {
  ...
  property("if throw with and without message") {
    val limit = 10
    ...
    val scriptThrow =
      ...
      """.stripMargin
    Seq(
      // +1 complexity for 'if' and +1 complexity for 'throw'
      (V1, 2, false),
      (V2, 2, false),
      (V3, 2, false),
      (V4, 2, false),
    ...
    val scriptThrowMsg =
      ...
      """.stripMargin
    Seq(
      // +1 complexity for 'if' and zero complexity for constant string and +1 complexity for 'throw(msg)'
      (V1, 2, false),
      (V2, 2, false),
      (V3, 2, false),
      (V4, 2, false),
