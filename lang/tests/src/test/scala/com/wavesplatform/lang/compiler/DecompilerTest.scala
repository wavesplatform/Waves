...
@Callable(i)
func foo () = [IntegerEntry("key", 1), BooleanEntry("key", true), StringEntry("key", "str"), BinaryEntry("key", base58''), ScriptTransfer(i.caller, 1, base58''), Issue(unit, 4, "description", true, "name", 1000), Reissue(base58'', false, 1), Burn(base58'', 1)]
