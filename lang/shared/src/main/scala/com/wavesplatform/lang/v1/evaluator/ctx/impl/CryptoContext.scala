...
object CryptoContext {
  ...
  def build(global: BaseGlobal, version: StdLibVersion, fixEcrecover: Boolean): CTX =
    ctxCache.getOrElse(
  ...
  private val ctxCache = mutable.HashMap.empty[(BaseGlobal, StdLibVersion, Boolean), CTX]

  private def buildNew(global: BaseGlobal, version: StdLibVersion, fixEcrecover: Boolean): CTX = {
    def functionFamily(
        startId: Short,
