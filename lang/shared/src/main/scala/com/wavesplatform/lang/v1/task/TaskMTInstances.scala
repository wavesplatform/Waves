...
trait TaskMTInstances {
  ...
  implicit def monadError[F[_] : Monad, S, E]: MonadError[TaskMT[F, S, E, ?], E] =
  ...
  implicit def monadState[F[_]: Monad, S, E]: MonadState[TaskMT[F, S, E, ?], S] = new MonadState[TaskMT[F, S, E, ?], S] {
