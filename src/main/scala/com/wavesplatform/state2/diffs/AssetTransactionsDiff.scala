...
object AssetTransactionsDiff {
  ...
  def issue(height: Int)(tx: IssueTransaction)(implicit addressScheme: AddressScheme): Either[ValidationError, Diff] = {
  ...
  def smartIssue(height: Int)(tx: SmartIssueTransaction)(implicit addressScheme: AddressScheme): Either[ValidationError, Diff] = {
  ...
  def reissue(state: SnapshotStateReader, settings: FunctionalitySettings, blockTime: Long, height: Int)(tx: ReissueTransaction)(
  ...
  def burn(state: SnapshotStateReader, height: Int)(tx: BurnTransaction)(implicit addressScheme: AddressScheme): Either[ValidationError, Diff] = {
  ...
  private def validateAsset(tx: SignedTransaction, state: SnapshotStateReader, assetId: AssetId)(
      implicit addressScheme: AddressScheme): Either[ValidationError, Unit] = {
