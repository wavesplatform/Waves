...
object FunctionalitySettings {
  val MAINNET = FunctionalitySettings(allowTemporaryNegativeUntil = 1479168000000L,
    ...
    allowExchangeTransactionAfter = 1489708800000L)
  ...
  def fromConfig(config: Config): FunctionalitySettings = {
    ...
    val allowExchangeTransactionAfter = config.as[Long](s"$configPath.allow-exchange-transaction-after")
    ...
    FunctionalitySettings(allowTemporaryNegativeUntil, allowInvalidPaymentTransactionsByTimestamp,
      ...
      allowBurnTransactionAfterTimestamp, allowLeaseTransactionAfterTimestamp, requirePaymentUniqueId, allowExchangeTransactionAfter)
  }
}
