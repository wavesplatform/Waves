  ...
  def unverified(settings: FunctionalitySettings, currentBlockTimestamp: Long, currentBlockHeight: Int)(
    ...
    stats.transactionDiffValidation.measureForType(tx.builder.typeId) {
      tx match {
        ...
        case mtx: MassTransferTransaction => MassTransferTransactionDiff(blockchain, settings, currentBlockTimestamp, currentBlockHeight)(mtx)
        ...
        case etx: ExchangeTransaction     => ExchangeTransactionDiff(blockchain, settings, currentBlockHeight)(etx)
