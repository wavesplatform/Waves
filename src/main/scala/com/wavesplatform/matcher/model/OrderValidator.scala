...
import com.wavesplatform.settings.{AssetType, DeviationsSettings, OrderRestrictionsSettings}
...
object OrderValidator {
  ...
  private def validateOrderFee(order: Order, orderFeeSettings: OrderFeeSettings): Result[Order] = {
