...
import com.wavesplatform.metrics.TxProcessingStats.TxStatsHolder
...
final case class TxProcessingStats(component: String) {
  ...
  private val txIdentifiers = TransactionParsers.all.values.toList.map { builder =>
    ...
    (builder.typeId, TxStatsHolder(txTypeName, component))
  }.toMap
...
object TxProcessingStats {
  final case class TxStatsHolder(txTypeName: String, component: String) {
