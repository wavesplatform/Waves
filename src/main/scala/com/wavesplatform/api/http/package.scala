      ...
      case JsSuccess(value, _) =>
        ...
        PublicKeyAccount
          ...
          .flatMap { senderPk =>
              ...
              TransactionParsers.by(typeId, version) match {
                ...
                case Some(x) =>
                  x match {
                    ...
                    case ContractInvocationTransaction => TransactionFactory.contractInvocation(txJson.as[ContractInvocationRequest], senderPk)
            ...
            if (result.isRight) result else legacyParse
          }
