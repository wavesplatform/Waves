...
case class SignedAliasRequest(@ApiModelProperty(value = "Base58 encoded sender public key", required = true)
...
object SignedAliasRequest {
  implicit val broadcastAliasRequestReadsFormat: Format[SignedAliasRequest] = Json.format
}
