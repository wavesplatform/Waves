        ...
        val r = TransactionParsers.by(typeId, version) match {
          ...
          case Some(x) =>
            x match {
              ...
              case CreateAliasTransactionV1  => TransactionFactory.alias(jsv.as[CreateAliasRequest], wallet, time)
        ...
        val r = TransactionParsers.by(typeId, version) match {
          ...
          case Some(x) =>
            x match {
              ...
              case CreateAliasTransactionV1  => jsv.as[SignedCreateAliasRequest].toTx
