...
class BlockchainSettingsSpecification extends FlatSpec with Matchers {
  ...
  it should "read testnet settings" in {
    ...
    settings.functionalitySettings.allowInvalidReissueInSameBlockUntilTimestamp should be(1524009600000L)
    settings.functionalitySettings.allowMultipleLeaseCancelTransactionUntilTimestamp should be(1524009600000L)
