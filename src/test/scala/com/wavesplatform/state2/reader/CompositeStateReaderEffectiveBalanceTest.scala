...
//            EffectiveBalanceSnapshot(acc, innerHeight + 80, 10000, 50000, 0, 0)))
//
//        val inner = stub[StateReader]
...
//          heightDiff = heightDiff,
//          effectiveBalanceSnapshots = Seq(
//            EffectiveBalanceSnapshot(acc, innerHeight + 80, 20000, 4000, 0, 0),
//            EffectiveBalanceSnapshot(acc, innerHeight + 50, 50000, 20000, 0, 0),
//            EffectiveBalanceSnapshot(acc, innerHeight + 90, 4000, 10000, 0, 0)))
//
//        val inner = stub[StateReader]
//        (inner.height _).when().returns(innerHeight)
//
...
//          heightDiff = heightDiff,
//          effectiveBalanceSnapshots = Seq(
//            EffectiveBalanceSnapshot(acc, 80, 2000, 10000, 0, 0),
//            EffectiveBalanceSnapshot(acc, 90, 10000, 50000, 0, 0)))
//
//        val inner = stub[StateReader]
