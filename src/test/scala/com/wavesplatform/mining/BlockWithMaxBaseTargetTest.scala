...
object BlockWithMaxBaseTargetTest {
  ...
  final case class Env(settings: WavesSettings, pos: PoSSelector, bcu: BlockchainUpdater with NG, utxPool: UtxPool, schedulerService: SchedulerService, miner: PrivateKeyAccount, lastBlock: Block)
}
