...
class InvokeScriptTransactionGrpcSuite extends GrpcBaseTransactionSuite {
  ...
  protected override def beforeAll(): Unit = {
    ...
    val script2 = ScriptCompiler.compile(scriptTextV4, ScriptEstimatorV3(fixOverflow = true)).explicitGet()._1
    val script3 = ScriptCompiler.compile(scriptTextV5, ScriptEstimatorV3(fixOverflow = true)).explicitGet()._1
